...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_show.setStyleSheet("border-image: url(UIProgram/ui_imgs/12.png);")
        ...
        self.label_3.setGeometry(QtCore.QRect(210, 0, 901, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于YOLOv11的交通标志检测识别系统"))
        ...
        self.label_3.setText(_translate("MainWindow", "基于YOLOv11的交通标志检测识别系统")) 
